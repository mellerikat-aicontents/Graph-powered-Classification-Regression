...
GCR 3.1.0을 사용하기 위해서는 ALO version 2.3.2를 설치합니다.   
<br />

작업 directory를 준비합니다 (여기에서는 예를 들어 aisolution_gcr_3.1.0이라는 directory를 생성합니다).   
<br />

\$ mkdir aisolution_gcr_3.1.0   
\$ cd aisolution_gcr_3.1.0   
<br />
...
+ ***ALO 설치가 완료되었으면, GCR 3.1.0을 설치합니다.***   
<br />
...
\$ cd solution   
\$ git status => 결과가 'On branch release-3.1.0'이 맞는 지 확인합니다.   
<br />

만일 다른 version이 설치되었다면, release-3.1.0을 다시 설치합니다.   
<br />

\$ cd ..   
\$ \rm -rf solution   
\$ git clone -b release-3.1.0 http://mod.lge.com/hub/dxadvtech/aicontents/gcr.git solution   
<br />

Default로 제공되는 sample data 대신 다른 data를 이용하려면 아래와 같이 experimental_plan.yaml을 수정합니다.   
<br />

\$ vi aisolution_gcr_3.1.0/gcr_solution/solution/experimental_plan.yaml   
<br />
...
\$ cd aisolution_gcr_3.1.0/gcr_solution   
